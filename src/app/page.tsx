...
const PRICE_FILTERS = {
  ...
  options: [
    ...
    { value: [0, 20], label: "Under 20$" }, // TODO: here we should use the formatter helper
    { value: [0, 40], label: "Under 40$" }
    // custom define in JSX
  ]
} as const;
...
export default function Home() {
  ...
  const debounceSubmitCallBack = useCallback(debounceSubmit, []);
